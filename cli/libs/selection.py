...
#end
def pb():
	beta = [ "b.1.8.1", "b1.8", "b1.7.3", "b1.7.2" "b1.7", "b1.6.6", "b1.6.5", "b1.6.4", "b1.6.3", "b1.6.2", "b1.6.1", "b1.6", "b1.5_01", "b1.5_01", "b1.5", "b1.4_01", "b1.4", "b1.3_01", "b1.3", "b1.2_01", "b1.2", "b1.1_02", "b1.1_01", "b1.1.0.2", "b1.0_01", "b1.0"]
...
#end
def pa():
	alpha = [ "a1.2.6", "a1.2.5", "a1.2.4_01", "a1.2.3_04", "a1.2.3_02", "a1.2.3_01", "a1.2.3", "a1.2.2b", "a1.2.2a", "a1.2.1_01", "a1.2.1", "a1.2.0_02", "a1.2.0_01", "a1.2.0", "a1.1.1_01", "a1.1.2", "a1.1.0", "a1.0.17_04", "a1.0.17_02", "a1.0.16", "a1.0.15", "a1.0.14", "a1.0.11", "a1.0.5_01", "a1.0.4", "inf-20100618", "c0.30_o1c", "c0.0.13a", "c0.0.13a_03", "c0.0.11", "rd-161348", "rd-160052", "rd-20090515", "rd-132328", "rd-132211"]
